package com.mrbarin.elastic.index.client.service.impl;

import com.mrbarin.demo.config.ElasticConfigData;
import com.mrbarin.elastic.index.client.service.ElasticIndexClient;
import com.mrbarin.elastic.index.client.util.ElasticIndexUtil;
...
public class TwitterElasticIndexClient implements ElasticIndexClient<TwitterIndexModel> {
    ...
    public List<String> save(List<TwitterIndexModel> documents) {
        ...
        List<String> documentsId = indexedObjectInformations.stream()
                .map(IndexedObjectInformation::getId).collect(Collectors.toList());
        LOG.info("Documents indexed successfully with type {} and ids {}",
                TwitterIndexModel.class.getName(), documentsId);
        return documentsId;
    }
}
