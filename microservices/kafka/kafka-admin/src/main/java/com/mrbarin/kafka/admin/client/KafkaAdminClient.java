package com.mrbarin.kafka.admin.client;

import com.mrbarin.demo.config.KafkaConfigData;
import com.mrbarin.demo.config.RetryConfigData;
import com.mrbarin.kafka.admin.exceptions.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    public void checkTopicsCreated(){
        Collection<TopicListing> topics = geTopics();
        int retryCount = 1;
    ...
    private HttpStatus getSchemaRegistryStatus(){
        try{
            return webClient
                    ...
                    .exchangeToMono(Mono::justOrEmpty)
    ...
    private Collection<TopicListing> geTopics(){
